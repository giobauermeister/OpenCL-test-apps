...
#define DATA_SIZE 21
unsigned int InitialData1[DATA_SIZE] = {0,8,4,3,5,7,0,8,3,9,2,4,5,6,7,8,9,0,1,2,3};
unsigned int InitialData2[DATA_SIZE] = {0,2,5,7,8,5,9,9,4,3,9,7,5,6,8,8,9,9,9,8,7};
...
const char* OpenCLSource = {
    ...
    "   unsigned int s = (iVGet1[n]+iVGet2[n]);"
...
void copy_array(unsigned int source_arr[], unsigned int target_arr[], unsigned int size)
{
...
int main(int argc, char **argv)
{
    ...
    do
    {
        ...
        sizeof(unsigned int) * nSize, NULL, NULL);
        // Allocate output memory on GPU
